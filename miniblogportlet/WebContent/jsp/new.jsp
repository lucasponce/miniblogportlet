...
<portlet:actionURL var="saveContentURL">
	<portlet:param name="action" value="newentry" />
...
<div class="blog_entry">
	...
	<p><input class="blog_entry_form_title" type="text" name="entrytitle" id="entrytitle" tabindex="1" value="" /></p>
	<p>tags	</p>
	<c:set var="taglist" value="" />
	<c:forEach var="tag" items="${entry.tags}">
		<c:set var="taglist" value="${taglist}${tag} " />
	</c:forEach>
	<p><input class="blog_entry_form_tags" type="text" name="entrytags" id="entrytags" tabindex="1" value="" /></p>	
	<div class="blog_entry_detail">Content</div>
	<p><textarea id="${n}inputcontent" class="centerEditor" name="entrycontent" cols="50" rows="50"></textarea>
	</p>
